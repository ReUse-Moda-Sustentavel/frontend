    ...
    <div className="  flex justify-center font-italiana text-reuse-green h-30 px-10 ">
      <div className=" space-y-2  container flex flex-col items-center py-9">
        ...
        <p className='py-8 text-2xl font-sans'>Somos um grupo de pessoas apaixonadas pela moda e pelo meio ambiente.
          ...
          Acreditamos que cada peça de roupa merece uma segunda chance,
          e por isso criamos a ReUse Moda Sustentável,
        ...
        <div className=" space-y-2  container flex flex-col items-center ">
          ...
          <p className='py-8 text-2xl font-sans'>Nosso objetivo é minimizar o impacto ambiental da indústria da moda,
            ...
            valorizando sua qualidade e seu potencial de continuar a proporcionar estilo e propósito
          </p>
          <p className='text-4xl font-bold'>Equipe </p>
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg">
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  ...
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/amandamachadomgr/" target="_blank">
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  <a className=" flex justify-center " href="https://github.com/Brunna-Bonilha" target="_blank">
                    <GithubLogo size={32} weight="fill" /></a>
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/bbonilha/" target="_blank">
                    <LinkedinLogo size={32} weight="fill" /></a>
                </p>
              </div>
            </div>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  <a className=" flex justify-center " href="https://github.com/Evertonpsf" target="_blank">
                    <GithubLogo size={32} weight="fill" /></a>
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/everton-figueiredo-3722b5178/" target="_blank">
                    <LinkedinLogo size={32} weight="fill" /></a>
                </p>
              </div>
            </div>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  <a className=" flex justify-center " href="https://github.com/Jhonata-vss" target="_blank">
                    <GithubLogo size={32} weight="fill" /></a>
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/jhonata-venicius/" target="_blank">
                    <LinkedinLogo size={32} weight="fill" /></a>
                </p>
              </div>
            </div>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  <a className=" flex justify-center " href="https://github.com/mpaulas" target="_blank">
                    <GithubLogo size={32} weight="fill" /></a>
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/mpaulas/" target="_blank">
                    <LinkedinLogo size={32} weight="fill" /></a>
                </p>
              </div>
            </div>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-black flex justify-center font-mono text-2xl">
                  <a className=" flex justify-center " href="https://github.com/vinicius-zanchetta" target="_blank">
                    <GithubLogo size={32} weight="fill" /></a>
                  <a className=" flex justify-center " href="https://www.linkedin.com/in/vinicius-zanchetta/" target="_blank">
                    <LinkedinLogo size={32} weight="fill" /></a>
                </p>
              </div>
            </div>
